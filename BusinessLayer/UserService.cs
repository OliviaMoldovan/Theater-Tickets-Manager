...
namespace BusinessLayer
{
    public class UserService : IUserService
    {
        ...
        public async Task<UserModel> Delete(DeleteUserModel user)
        {
            try
            {
                var existingUser = await _userManager.FindByNameAsync(user.Username);
        ...
        public async Task<UserModel> Update(UpdateUserModel user)
        {
            try
            {
                var existingUser = await _userManager.FindByNameAsync(user.Username);
                ...
                if (user != null)
                {
                    ...
                    var updatedUser = await _userManager.FindByNameAsync(newUser.UserName);
