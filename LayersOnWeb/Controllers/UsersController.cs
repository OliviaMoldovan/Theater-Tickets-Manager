...
namespace LayersOnWeb.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPut("UpdateCashier")]
        [Authorize(Roles = "Admin")]
        public async Task<UserModel> Update([FromBody] UpdateUserModel user)
        {
        ...
        [HttpDelete("DeleteCashier")]
        [Authorize(Roles = "Admin")]
        public async Task<UserModel> Delete([FromBody] DeleteUserModel user)
        {
